...
また、パラメータとして官僚を受け取るフォームのメンバー関数beSigned()も追加します。官僚の評価が十分高い（必須の評価と同じかそれ以上）場合、フォームの状態を「署名済み」に変更します。評価1は評価2よりも高いことを覚えておいてください。評価が低すぎる場合は、Form::GradeTooLowException をスローします。
